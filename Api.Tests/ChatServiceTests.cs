...
public class ChatServiceTests
{
    ...
    public async Task ProcessAsync_ShouldReturnResponse_WhenInstructionsProvided()
    {
        ...
        _mockChatHistoryRepository.Verify(r => r.InsertAsync(It.IsAny<Api.Domain.Database.Entites.ChatHistoryEntity>()), Times.Once);
    ...
    public async Task ProcessAsync_ShouldThrowException_WhenAiServiceNotFound()
    {
        ...
        _mockChatHistoryRepository.Verify(r => r.InsertAsync(It.IsAny<Api.Domain.Database.Entites.ChatHistoryEntity>()), Times.Never);
    }
